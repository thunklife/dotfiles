...
" Nu
" ---------------
au BufNewFile,BufRead *.nu,*.nujson,Nukefile setf n
...
" ES6
" _______________
au BufRead,BufNewFile *.js6 set ft=javascript syntax=javascript
...
" ColorV
" ------
let g:colorv_preview_ftype = 'css,javascript,scss,stylus,less'
